...
- Use `npm run desktop:install-local` to update the stable Windows development installation after changes are merged. GeRAFE must be closed while its installed executable is replaced.
